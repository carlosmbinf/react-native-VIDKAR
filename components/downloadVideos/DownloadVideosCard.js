        ...
        <View
          ...
          <View
            ...
            <View style={{width: '90%', alignItems: 'center'}}>
              <Text style={{color: 'white'}}>{itemlocal.nombreFile}</Text>
            </View>
            <View style={{width: '10%'}}>
          ...
          <View
            ...
            <Button
              onPress={() => {
                ...
                props.navigation.navigationGeneral.navigate('Video', item);
                setModalVisible(false);
              }}
              title="Learn More"
              color="#3f51b5"
...
export default DownloadVideosCard;
