...
const styles = StyleSheet.create({
  ...
  playerScreen: { ...StyleSheet.absoluteFill, backgroundColor: "#000", zIndex: 20 },
  ...
  playerLoadingOverlay: { ...StyleSheet.absoluteFill, alignItems: "center", justifyContent: "center", gap: 10, backgroundColor: "rgba(0, 0, 0, 0.18)", zIndex: 2 },
  posterLoading: { color: "#fff", fontWeight: "700" },
  playerOverlayCenter: { ...StyleSheet.absoluteFill, alignItems: "center", justifyContent: "center", paddingHorizontal: 18, zIndex: 5 },
