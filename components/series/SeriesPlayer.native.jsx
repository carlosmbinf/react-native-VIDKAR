...
const SeriesPlayer = () => {
  ...
  const handleBack = React.useCallback(() => { cancelSeriesHlsSession(cancelUrlRef.current); if (router.canGoBack()) router.back(); else router.replace("/(normal)/Series"); }, [cancelSeriesHlsSession, router]);
